            ...
            "queries": [
                ...
                "Query": {
                    "Commands": [
                    {
                        ...
                        "Query": {
                            "Version": 2,
                            "From": [{ "Name": "i", "Entity": "ICTs", "Type": 0 }],
                            "Select": [
                            {
                                "Column": {
                            ...
                            },
                            {
                                ...
                                "Expression": {
                                    "Column": {
                                    "Expression": { "SourceRef": { "Source": "i" } },
                                    "Property": "Endereço Completo"
                                    }
                                },
                                "Function": 3
                                },
                                "Name": "Min(ICTs.Endereço Completo)",
                                "NativeReferenceName": "Endereço Completo"
                            },
                            {
                                "Aggregation": {
                                "Expression": {
                            ...
                            },
                            {
                                ...
                                "Expression": {
                                    "Column": {
                                    "Expression": { "SourceRef": { "Source": "i" } },
                                    "Property": "Telefone (com DDD)"
                                    }
                                },
                                "Function": 3
                                },
                                "Name": "Min(ICTs.Telefone (com DDD))",
                                "NativeReferenceName": "Telefone (com DDD)"
                            },
                            {
                                "Aggregation": {
                                "Expression": {
                        ...
                        "Binding": {
                            ...
                            "SuppressedJoinPredicates": [2, 3, 4, 5, 6, 7, 8, 9],
                            "Version": 1,
                            "DataReduction": {
                            "DataVolume": 4,
                            "Primary": {
