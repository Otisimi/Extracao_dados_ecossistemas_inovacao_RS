...
api_url = "http://apigw-proxy.capes.gov.br/observatorio/data/observatorio/producao"
query = "ano-base:(2024);subtipo-producao:(29)"
size = 100
page, all_data = 0, []
...
with open("patentes_sucup.json", "w", encoding="utf-8") as f:
